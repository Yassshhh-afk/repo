      ...
      <div className={`min-h-screen galaxy-bg text-white ${libreBaskerville.className}`}>
        ...
        <nav className="flex items-center justify-between px-6 py-4 md:px-12 md:py-6 bg-black/20 backdrop-blur-sm">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link href="/about" className="text-galaxy-gold font-semibold transition-colors">
              About
            </Link>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="order-1 lg:order-2">
                <div className="relative max-w-md mx-auto">
                  ...
                  <div className="relative w-full aspect-[3/4] rounded-3xl overflow-hidden shadow-2xl bg-galaxy-gold/20 backdrop-blur-sm border border-galaxy-gold/30">
                    <Image
                  ...
                  {/* Decorative Elements */}
                  <div className="absolute -top-4 -right-4 w-24 h-24 bg-galaxy-gold/20 rounded-full blur-xl"></div>
                  <div className="absolute -bottom-4 -left-4 w-32 h-32 bg-galaxy-purple/20 rounded-full blur-2xl"></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
              ...
              <div className="space-y-6">
                <h2 className="text-2xl md:text-3xl font-bold text-galaxy-gold mb-6">
                  How I Got Here
                </h2>
                ...
                <div className="bg-galaxy-gold/10 p-6 rounded-lg border-l-4 border-galaxy-gold backdrop-blur-sm">
        ...
        <section className="bg-black px-6 md:px-12 py-16 md:py-24">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-galaxy-gold mb-8 text-center">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-galaxy-deep-purple/30 p-8 rounded-lg backdrop-blur-sm">
              ...
              <p className="text-lg leading-relaxed text-white/80">
                Through years of dedicated study, meditation, and practice, I developed the ability to access the <strong className="text-galaxy-gold">Akashic Records</strong>—the energetic archive of every soul's journey. This sacred practice revealed not only my own life purpose but also my gift for helping others navigate their spiritual path.
              </p>
              
              <p className="text-lg leading-relaxed text-white/80">
                What started as personal healing evolved into a profound calling to serve others. I discovered that my corporate background, combined with spiritual wisdom, created a unique approach to <strong className="text-galaxy-gold">soul-level transformation</strong>. Today, I guide individuals through their own awakening, helping them release karmic patterns, heal soul wounds, and step into their authentic power.
              </p>
              
              <p className="text-lg leading-relaxed text-white/80">
                Each session I facilitate is a sacred space where <strong className="text-galaxy-gold">healing, clarity, and transformation</strong> naturally unfold. My clients don't just receive guidance—they experience profound shifts that ripple through every aspect of their lives, empowering them to live from their highest potential.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="galaxy-bg px-6 md:px-12 py-16 md:py-24">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-galaxy-gold mb-12 text-center">
              What We Offer
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              {/* Service Card 1 */}
              <div className="group bg-black/40 backdrop-blur-sm p-8 rounded-xl shadow-lg hover:bg-galaxy-deep-purple/40 transition-all duration-500 cursor-pointer hover:shadow-2xl hover:scale-105 border border-galaxy-gold/20">
        ...
        <section className="bg-black px-6 md:px-12 py-16 md:py-24">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <h3 className="text-xl font-semibold text-galaxy-gold mb-4">
        ...
        <section className="galaxy-bg px-6 md:px-12 py-16 md:py-24">
          <div className="max-w-4xl mx-auto text-center bg-black/40 backdrop-blur-sm rounded-2xl p-8">
            <h2 className="text-3xl md:text-4xl font-bold text-galaxy-gold mb-8">
              Beyond the Coach
            </h2>
            
            <div className="space-y-6">
              <p className="text-lg leading-relaxed text-white/80">
                When I'm not guiding souls through their spiritual journey, you'll find me practicing <strong className="text-galaxy-gold">Hatha Yoga</strong>, connecting with the ancient wisdom of body and breath. This practice keeps me grounded and centered, allowing me to hold sacred space for my clients with presence and clarity.
              </p>
              
              <p className="text-lg leading-relaxed text-white/80">
                I'm also deeply passionate about <strong className="text-galaxy-gold">Indian Classical Dance</strong>, which serves as both artistic expression and moving meditation. Through dance, I embody the divine feminine energy and celebrate the sacred stories that connect us all to our cultural and spiritual heritage.
              </p>
              
              <div className="bg-galaxy-gold/10 p-8 rounded-lg mt-8 backdrop-blur-sm">
        ...
        <div className="md:hidden fixed bottom-6 left-6 right-6">
          <div className="bg-galaxy-dark rounded-lg p-4 shadow-lg border border-galaxy-gold/20">
            <div className="flex justify-around">
              <Link href="/about" className="text-sm text-galaxy-gold font-semibold transition-colors">
                About
              </Link>
