      ...
      <div className={`min-h-screen galaxy-bg text-white ${libreBaskerville.className}`}>
        ...
        <section className="px-6 md:px-12 py-16 md:py-24">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1
              className="text-4xl md:text-5xl lg:text-6xl leading-tight mb-8 text-white animate-fadeInUp"
            ...
            <p
              className="text-lg md:text-xl leading-relaxed text-white/80 max-w-2xl mx-auto animate-fadeInUp"
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
              ...
              <div className="bg-black/40 backdrop-blur-sm rounded-2xl p-8 border border-galaxy-gold/20 animate-slideInLeft">
                <h2 className="text-2xl md:text-3xl font-bold text-galaxy-gold mb-8">Send us a Message</h2>
              ...
              <div className="space-y-8 animate-slideInRight">
                ...
                <div className="bg-black/40 backdrop-blur-sm rounded-2xl p-8 border border-galaxy-gold/20">
                  <h2 className="text-2xl md:text-3xl font-bold text-galaxy-gold mb-8">Get in Touch</h2>
                ...
                {/* WhatsApp Button */}
                <div className="bg-black/40 backdrop-blur-sm rounded-2xl p-8 border border-galaxy-gold/20">
                  <h3 className="text-xl font-bold text-galaxy-gold mb-4">Quick Connect</h3>
                  <p className="text-white/80 mb-6">
              ...
              <div className="space-y-6">
                <div className="animate-fadeInUp" style={{ animationDelay: "0.2s" }}>
                  ...
                  <p className="text-white/80">
                    You can book through our contact form, WhatsApp, or email. We'll respond within 24 hours to schedule
                    your session.
                  </p>
                </div>
                ...
                <div className="animate-fadeInUp" style={{ animationDelay: "0.4s" }}>
                  ...
                  <p className="text-white/80">
                    Yes! We offer both online and in-person sessions. Online sessions are just as effective as in-person
                    readings.
                  </p>
                </div>
              </div>
