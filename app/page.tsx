    ...
    <>
      ...
      <div className={`min-h-screen beige-bg text-elegant-blue ${libreBaskerville.className}`}>
        ...
        <nav className="flex items-center justify-between px-6 py-4 md:px-12 md:py-6 bg-white/60 backdrop-blur-sm animate-fadeInDown border-b border-elegant-blue/10">
          <div className="text-xl md:text-2xl text-elegant-blue font-bold hover:text-accent-gold transition-colors duration-300 animate-pulse-slow">
            AkashicReading.
          </div>
          ...
          <Button className="bg-elegant-blue text-warm-beige hover:bg-deep-blue px-6 py-2 rounded-lg shadow-md transition-all duration-300 hover:scale-105 btn-hover-effect animate-fadeInDown stagger-5">
            Book Now
          </Button>
        </nav>
              ...
              <div className="space-y-6 order-1 lg:order-1 animate-scaleIn stagger-2">
                <div className="relative hover-lift">
                  <Image
                    ...
                    width={600}
                    height={800}
                    className="w-full max-w-md mx-auto rounded-lg shadow-2xl object-cover border-2 border-accent-gold/40 transition-all duration-500 hover:border-accent-gold/80 transform -scale-x-100"
                    priority
                  />
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {services.map((service, index) => (
                <Link key={service.id} href={`/${service.title.toLowerCase().replace(/\s+/g, "-")}`} className="block">
                  <div className="bg-elegant-blue/20 p-8 rounded-xl border border-accent-gold/30 hover:bg-elegant-blue/30 hover:scale-[1.02] transition-all duration-300 group cursor-pointer h-full">
        ...
        <section className="beige-bg px-6 md:px-12 py-16 md:py-24">
          <div className="max-w-4xl mx-auto bg-white/70 backdrop-blur-sm rounded-2xl p-8 animate-scaleIn border border-elegant-blue/10">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl lg:text-5xl leading-tight mb-4 text-elegant-blue">Our Clients Say</h2>
            </div>
        ...
        <section className="bg-elegant-blue px-6 md:px-12 py-16 md:py-24">
          <div className="max-w-4xl mx-auto text-center animate-fadeInUp">
            <h2 className="text-3xl md:text-4xl lg:text-5xl leading-tight text-warm-beige mb-6">
              Begin Your Journey Within — With Me as Your Guide
            </h2>

            <p className="text-lg md:text-xl leading-relaxed text-warm-beige/90 mb-8 max-w-2xl mx-auto">
