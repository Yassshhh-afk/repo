  ...
  return (
    <>
      ...
      <div className={`min-h-screen galaxy-bg text-white ${libreBaskerville.className}`}>
        {/* Navigation */}
        <nav className="flex items-center justify-between px-6 py-4 md:px-12 md:py-6 bg-black/20 backdrop-blur-sm animate-fadeIn">
          <div className="text-xl md:text-2xl text-galaxy-gold text-glow">
            AkashicReading.
          </div>
          
          <div className="hidden md:flex items-center space-x-8">
            <Link href="/about" className="hover:text-galaxy-gold transition-colors duration-300">
              About
            </Link>
            <Link href="/services" className="hover:text-galaxy-gold transition-colors duration-300">
              Services
            </Link>
            <Link href="/journal" className="hover:text-galaxy-gold transition-colors duration-300">
              Journal
            </Link>
            <Link href="/contact" className="hover:text-galaxy-gold transition-colors duration-300">
              Contact
            </Link>
          </div>

          <Button 
            className="bg-galaxy-deep-purple text-white hover:bg-galaxy-purple px-6 py-2 rounded-lg shadow-md transition-all duration-300 hover:scale-105"
          >
            Book Now
          </Button>
        </nav>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="space-y-8 order-2 lg:order-1">
                <div className="space-y-6">
                  <p className="text-lg md:text-xl text-galaxy-gold animate-fadeInUp">
                    Hello, I'm Remya
                  </p>
                  
                  <h1 className="text-4xl md:text-5xl lg:text-6xl leading-tight text-white animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
                    I guide you through the{" "}
                    <span className="text-galaxy-gold text-glow">Akashic</span>{" "}
                    to uncover your soul's truth and empower your healing journey.
                  </h1>
                </div>

                <Link href="#about" className="flex items-center space-x-3 pt-8 hover:text-galaxy-gold transition-colors duration-300 animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
              ...
              {/* Right Column - Image */}
              <div className="space-y-6 order-1 lg:order-2 animate-scaleIn" style={{ animationDelay: '0.3s' }}>
                ...
                {/* Decorative Elements */}
                <div className="flex flex-col space-y-3 max-w-md mx-auto animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
                  <div className="h-1 bg-galaxy-gold rounded-full"></div>
                  <div className="h-1 bg-galaxy-gold rounded-full w-3/4"></div>
                  <div className="h-1 bg-galaxy-gold rounded-full w-1/2"></div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="space-y-8 animate-slideInLeft">
                ...
                <div className="space-y-6 relative z-20">
                  <Link href="/about">
                    <button className="border border-galaxy-gold bg-transparent text-galaxy-gold px-8 py-3 rounded-lg hover:bg-galaxy-gold hover:text-black transition-all duration-300 hover:scale-105">
                      More About Me
                    </button>
                  </Link>
                  ...
                  <div className="flex space-x-6">
                    <a href="#" className="text-white hover:text-galaxy-gold transition-colors duration-300 hover:scale-110">
        ...
        <section className="bg-galaxy-deep-purple px-6 md:px-12 py-16 md:py-24">
          <div className="max-w-4xl mx-auto text-center animate-fadeInUp">
            ...
            <Button 
              className="bg-galaxy-gold text-black hover:bg-galaxy-gold-light px-8 py-4 text-lg font-semibold rounded-lg shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105"
            >
              Book Now
            </Button>
          </div>
